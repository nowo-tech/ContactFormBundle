 ...
 * }
 * @psalm-type NowoContactFormConfig = array{
 *     client_entity_class?: scalar|Param|null, // Optional FQCN of the host client entity for linking submissions. // Default: null
 *     client_label_property?: scalar|Param|null, // Property or getter used to display linked clients in admin. // Default: "email"
 *     client_user_accessor?: scalar|Param|null, // Optional method on the authenticated user that returns the client entity (e.g. getClient). // Default: null
 *     ip_anonymization_salt?: scalar|Param|null, // Salt used when hashing IP addresses for GDPR storage. // Default: "%kernel.secret%"
 *     default_retention_days?: int|Param, // Default data retention period for new contact forms. // Default: 365
 *     phone_prefixes?: list<scalar|Param|null>,
 *     phone_input?: array{
 *         value_format?: scalar|Param|null, // Model format passed to PhoneInputBundle PhoneType (CONCATENATED recommended for submissions). // Default: "CONCATENATED"
 *         default_country?: scalar|Param|null, // Fallback default country ISO when a phone field does not specify one. // Default: "ES"
 ...
 *         default_recipient?: scalar|Param|null, // Fallback notification recipient when the form has no notification_email. // Default: null
 *         mailer?: array{
 *             enabled?: bool|Param, // Send email via symfony/mailer when installed. // Default: false
 *             from?: scalar|Param|null, // Sender address for mailer notifications. // Default: "noreply@example.com"
 *             subject?: scalar|Param|null, // Email subject template; {form} is replaced with the form name. // Default: "New contact submission: {form}"
 *         },
 *     },
 *     file_upload?: array{
 *         service?: scalar|Param|null, // Custom service id implementing ContactFormFileUploadHandlerInterface (required for file fields). // Default: null
 *     },
 *     public_submission_rate_limit?: array{ // Rate limit for public form submissions per IP and form slug.
 *         enabled?: bool|Param, // Default: true
 *         limit?: int|Param, // Default: 5
 *         interval_seconds?: int|Param, // Default: 60
 *     },
 *     doctrine?: array{
 *         table_prefix?: scalar|Param|null, // Prefix prepended to table names (nowo_contact_form, nowo_contact_submission, …). Empty = no prefix. // Default: ""
 *     },
 * }
 ...
 *     nowo_contact_form?: NowoContactFormConfig,
